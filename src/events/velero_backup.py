...
class VeleroBackupEvents(BaseEventHandler):
    ...
    def publish_to_relation(self, relation: Relation) -> None:
        ...
        for target in targets:
            ...
            self.logger.info(
                "Published backup spec from %s to %s relation %s",
                target.app_name,
